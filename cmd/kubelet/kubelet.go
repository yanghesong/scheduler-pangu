...
import (
	...
	"k8s.io/component-base/metrics/prometheus/clientgo" // for client metric registration
	"k8s.io/component-base/metrics/prometheus/version"  // for version metric registration
